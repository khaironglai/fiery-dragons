...
class SalamanderCC(ChitCard):
    """
    This class is used to create a Salamander chit card object.
    This chit card is for letting the game to have a memory-card like feature.
    """
    ANIMAL_TYPE = AnimalType.SALAMANDER

    def __init__(self, animal_num):
        """
        This method initializes the Salamander chit card object.
        ...
        return: None
        """
        super().__init__(SalamanderCC.ANIMAL_TYPE, animal_num, 
                         f"images/chit cards/salamander {animal_num}.png")
