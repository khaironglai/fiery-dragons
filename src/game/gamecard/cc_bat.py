...
class BatCC(ChitCard):
    """
    This class is used to create a Bat chit card object.
    This chit card is for letting the game to have a memory-card like feature.
    """
    ANIMAL_TYPE = AnimalType.BAT

    def __init__(self, animal_num):
        """
        This method initializes the Bat chit card object.
        ...
        return: None
        """
        super().__init__(BatCC.ANIMAL_TYPE, animal_num,
                         f"images/chit cards/bat {animal_num}.png")
